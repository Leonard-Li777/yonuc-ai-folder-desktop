        ...
        tagsProcessList.forEach(t => {
          if (!dimMap.has(t.dimension_name)) {
            dimMap.set(t.dimension_name, {
              ...
              trigger_conditions: this.safeJsonParse(t.trigger_conditions, []),
              applicable_file_types: this.safeJsonParse(t.applicable_file_types, []),
              context_hints: this.safeJsonParse(t.context_hints, []),
